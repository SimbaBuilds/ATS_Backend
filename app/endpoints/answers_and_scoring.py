...
from app.models import Answer, QuestionBank  #
from app.schemas import SubmitAnswerResponse, GetAnswersResponse, UpdateAnswerResponse
...
async def submit_answer(answer_data: Answer, db: Session = Depends(get_db)):
    try:
